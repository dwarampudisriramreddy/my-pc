...
import com.ram.pc.R;
import com.ram.pc.app.event.SystemEventReceiver;
import com.ram.pc.app.terminal.TermuxTerminalSessionActivityClient;
import com.ram.pc.app.terminal.TermuxTerminalSessionServiceClient;
import com.ram.pc.shared.termux.plugins.TermuxPluginUtils;
import com.ram.pc.shared.data.IntentUtils;
import com.ram.pc.shared.net.uri.UriUtils;
import com.ram.pc.shared.errors.Errno;
import com.ram.pc.shared.shell.ShellUtils;
import com.ram.pc.shared.shell.command.runner.app.AppShell;
import com.ram.pc.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.ram.pc.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.ram.pc.shared.termux.shell.TermuxShellUtils;
import com.ram.pc.shared.termux.TermuxConstants;
import com.ram.pc.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.ram.pc.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.ram.pc.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.ram.pc.shared.termux.shell.TermuxShellManager;
...
import com.ram.pc.shared.notification.NotificationUtils;
import com.ram.pc.shared.android.PermissionUtils;
import com.ram.pc.shared.data.DataUtils;
import com.ram.pc.shared.shell.command.ExecutionCommand;
import com.ram.pc.shared.shell.command.ExecutionCommand.Runner;
import com.ram.pc.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.ram.pc.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.ram.pc.shared.R.string.error_execution_cancelled))) {
