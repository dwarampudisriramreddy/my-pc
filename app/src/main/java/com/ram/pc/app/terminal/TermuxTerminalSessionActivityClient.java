...
import com.ram.pc.shared.termux.terminal.io.BellHandler;
import com.ram.pc.shared.logger.Logger;
import com.ram.pc.terminal.TerminalColors;
import com.ram.pc.terminal.TerminalSession;
import com.ram.pc.terminal.TerminalSessionClient;
import com.ram.pc.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.ram.pc.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.ram.pc/com.ram.pc.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
