package com.ram.pc.shared.termux.file;

import static com.ram.pc.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
...
import com.ram.pc.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.ram.pc` as secondary user will result
     * in `ls: /data/user/0/com.ram.pc: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.ram.pc` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.ram.pc` where `10` is
