...
import com.ram.pc.shared.reflection.ReflectionUtils;
...
import com.ram.pc.shared.android.PackageUtils;
import com.ram.pc.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.ram.pc`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.ram.pc/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.ram.pc" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.ram.pc.shared.R.raw.apt_info_script);
        try {
