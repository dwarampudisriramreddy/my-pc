package com.ram.pc.shared.activities;
...
import com.ram.pc.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.ram.pc.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.ram.pc.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
